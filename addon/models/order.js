...
export default class OrderModel extends Model {
    ...
    async loadAllRelations(controller) {
        ...
        let { payload, driver_assigned, customer, facilitator, tracking_statuses } = this;
        ...
        if (isRelationMissing(this, 'driver_assigned')) {
            ...
            driver_assigned = await store.findRecord('driver', this.driver_assigned_uuid);
        ...
        if (isRelationMissing(this, 'customer', { polymorphic: true })) {
            ...
            customer = await store.findRecord(`customer-${this.customer_type}`, this.customer_uuid);
        ...
        if (isRelationMissing(this, 'facilitator', { polymorhpic: true })) {
            ...
            facilitator = await store.findRecord(`facilitator-${this.facilitator_type}`, this.facilitator_uuid);
