...
export default class ApplicationController extends Controller {
  ...
  @tracked routes = [
    ...
    'console.fleet-ops.management',
    'console.fleet-ops.comms',
  ];
  ...
  @computed('routes.[]') get isOpsNavigationsActive() {
    const allRoutesInactive = this.routes.every(
      (route) => !this.isRouteActive(route)
    );

    return (
      this.isRouteActive('console.fleet-ops.operations') ||
      allRoutesInactive ||
      true
    );
  }
